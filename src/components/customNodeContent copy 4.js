      ...
      <div style={styles.nodeDetails}>
        {props.data.team === "" ? (
          ...
          <div style={styles.nodeTeam}>
            <div style={styles.nodeTeamName}>{props.data.team} Holler</div>
            <div style={styles.nodeTeamMembersContainer}>
              {props.data.members && props.data.members.length > 0 ? (
                props.data.members.map((member, index) => (
                  <div key={index} style={styles.nodeTeamMemberContainer}>
                    <img
                ...
                <div style={{ color: 'white' }}>No Members</div>
              )}
            </div>
          </div>
        )}
